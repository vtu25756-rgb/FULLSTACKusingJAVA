...
-- Description:
-- This task simulates an online payment system using
-- database transactions. The payment amount is deducted
-- from the user account and added to the merchant account.
-- COMMIT is used on success and ROLLBACK on failure.
...
-- Deduct amount (will fail due to insufficient balance)
UPDATE users
SET balance = balance - 10000
WHERE user_id = 2 AND balance >= 10000;
